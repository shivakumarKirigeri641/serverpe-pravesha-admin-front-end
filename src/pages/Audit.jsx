...
const ACTIONS = {
  ...
  destination_changed: 'Changed a destination',
  destination_status_changed: 'Opened or closed a destination',
  checkpost_added: 'Added a checkpost',
  checkpost_changed: 'Changed a checkpost',
