...
const GROUPS = [
  ['See', ['dashboard.view', 'live.view', 'alerts.view', 'destinations.view', 'health.view', 'analytics.view', 'reports.view', 'finance.view', 'conversations.view', 'conversations.technical', 'negative.view']],
