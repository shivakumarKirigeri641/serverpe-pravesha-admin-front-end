...
const GROUPS = [
  ['See', ['dashboard.view', 'live.view', 'alerts.view', 'destinations.view', 'health.view', 'analytics.view', 'reports.view', 'finance.view', 'conversations.view', 'conversations.technical', 'negative.view', 'unverified.view']],
  ['Act', ['demo.simulate', 'demo.reset', 'alerts.act', 'announcements.manage', 'tickets.view', 'tickets.cancel', 'tickets.resend', 'negative.act', 'visitors.block', 'tickets.free', 'tickets.onspot', 'finance.expenses', 'finance.remit']],
